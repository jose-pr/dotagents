...
# `Env` on `Dotagents._subcommands_` below. Never logs DOTAGENTS_*/AGENTS_*
# VALUES -- output goes to stdout for the caller to consume; the logger only
# ever names vars (Leakage rule).
# --------------------------------------------------------------------------- #
