...
#
# Env: AGENTS_HOME (default $HOME/.agents),
...
# so its exports reach the `dotagents sync-project` subprocess below.
...
dotagents_cmd sync-project --agents-dir "$AGENTS_DIR" --project "$PROJECT_DIR" \
